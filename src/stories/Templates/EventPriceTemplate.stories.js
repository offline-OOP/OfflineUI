import EventPriceTemplate from "../../templates/EventPriceTemplate/EventPriceTemplate";
...
export default {
    title: 'Шаблоны/EventPriceTemplate',
    component: EventPriceTemplate,
    argTypes: {
        color: {
            control: {type: 'select'},
...
export const InCard = (args) => ({
    components: {EventPriceTemplate, Card, Avatar},
    data: () => ({
        img: {
    ...
    template: `
      <Card :color="color">
        <EventPriceTemplate :color="color">
          <template #avatar>
