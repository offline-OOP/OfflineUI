import ProfileMainTemplate from "../../templates/ProfileMainTemplate/ProfileMainTemplate";
...
export default {
    title: 'Шаблоны/ProfileMainTemplate',
    component: ProfileMainTemplate,
    argTypes: {
        color: {
            control: {type: 'select'},
...
export const Placeholder = (args) => ({
    components: {ProfileMainTemplate},
    setup: () => ({...args}),
    template: `
      <ProfileMainTemplate />
    `
...
export const InCard = (args) => ({
    components: {ProfileMainTemplate, Card, Avatar},
    data: () => ({
        img: {
    ...
    template: `
      <Card :color="color">
        <ProfileMainTemplate :color="color">
          <template #avatar>
