import ProfileCoverTemplate from "../../templates/ProfileCoverTemplate/ProfileCoverTemplate";
...
export default {
    title: 'Шаблоны/ProfileCoverTemplate',
    component: ProfileCoverTemplate,
    argTypes: {
        color: {
            control: {type: 'select'},
...
export const Placeholder = (args) => ({
    components: {ProfileCoverTemplate},
    setup: () => ({...args}),
    template: `
...
export const InCard = (args) => ({
    components: {ProfileCoverTemplate, Card, Avatar},
    data: () => ({
        img: {
    ...
    template: `
      <Card :color="color">
        <ProfileCoverTemplate :color="color">
          <template #avatar>
