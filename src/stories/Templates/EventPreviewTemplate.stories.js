import EventPreviewTemplate from "../../templates/EventPreviewTemplate/EventPreviewTemplate";
...
export default {
    title: 'Шаблоны/EventPreviewTemplate',
    component: EventPreviewTemplate,
    argTypes: {
        color: {
            control: {type: 'select'},
...
export const Placeholder = (args) => ({
    components: {EventPreviewTemplate},
    setup: () => ({...args}),
    template: `
...
export const InCard = (args) => ({
    components: {EventPreviewTemplate, Card, Avatar},
    data: () => ({
        img: {
    ...
    template: `
      <Card :color="color">
        <EventPreviewTemplate :color="color">
          <template #avatar>
