import EventPeopleTemplate from "../../templates/EventPeopleTemplate/EventPeopleTemplate";
...
export default {
    title: 'Шаблоны/EventPeopleTemplate',
    component: EventPeopleTemplate,
    argTypes: {
        color: {
            control: {type: 'select'},
...
export const Placeholder = (args) => ({
    components: {EventPeopleTemplate},
    setup: () => ({...args}),
    template: `
      <EventPeopleTemplate />
    `
...
export const InCard = (args) => ({
    components: {EventPeopleTemplate, Card, Avatar},
    data: () => ({
        img: {
    ...
    template: `
      <Card :color="color">
        <EventPeopleTemplate :color="color">
          <template #avatar>
