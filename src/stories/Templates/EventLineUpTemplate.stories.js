import EventLineUpTemplate from "../../templates/EventLineUpTemplate/EventLineUpTemplate";
...
export default {
    title: 'Шаблоны/EventLineUpTemplate',
    component: EventLineUpTemplate,
    argTypes: {
        color: {
            control: {type: 'select'},
...
export const Placeholder = (args) => ({
    components: {EventLineUpTemplate},
    setup: () => ({...args}),
    template: `
      <EventLineUpTemplate />
    `
...
export const InCard = (args) => ({
    components: {EventLineUpTemplate, Card, Avatar},
    data: () => ({
        img: {
    ...
    template: `
      <Card :color="color">
        <EventLineUpTemplate :color="color">
          <template #avatar>
