import NotifyTemplate from "../../templates/NotifyTemplate/NotifyTemplate";
...
export const InCard = (args) => ({
    components: {NotifyTemplate, Card, Avatar},
    data: () => ({
        img: {
